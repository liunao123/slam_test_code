...
#include <g2o/EXTERNAL/csparse/cs.h>
...
namespace myslam
{
    ...
    public:
        ...
        EdgeProjectionPoseOnly(const Vec3 &pose, const Mat33 &K)
            : _pos3d(pose), _K(K) {}
