...
namespace myslam
{
    ...
    void Viewer::ThreadLoop()
    {
        ...
        //add named OpenGL viewer to window and provide 3D handler
        pangolin::View &vis_dispy =
            pangolin::CreateDisplay().SetBounds(0.0, 1.0, 0.0, 1.0, -1024.0f / 768.0f).SetHandler(new pangolin::Handler3D(vis_camera));
